	...
	<nav class="navigation__navbar navbar-expand-sm navbar container">
		<div class="collapse navbar-collapse navigation__body no-transition" id="navbarSupportedContent">
			<ul class="navbar-nav navigation__primary">
				 ...
				 <li class="nav-item navigation__item">
					 <a class="nav-link no-small" href="#projekty">projekty
						 <span class="sr-only">(current)</span>
					 </a>
				 </li>
				 <li class="nav-item navigation__item">
					 <a class="nav-link no-small" href="#partnerzy">partnerzy</a>
				 </li>
				 <li class="nav-item navigation__item">
					 <a class="nav-link no-small" href="#zespol">zespół</a>
				 </li>
				 <li class="nav-item navigation__item">
					 <a class="nav-link no-small" href="#referencje">referencje</a>
				 </li>
				 <li class="nav-item navigation__item">
...
<div id="fullpage">
	<div class="section fullpage--1">
		<header class="d-flex justify-content-center align-items-center header">
			...
			<div class="container header__content">
				...
				<p class="header__description header__description--1">
				...
				<p class="header__description header__description--2">
              ...
              <div id="lead" class="col-sm-12 col-md-4 pb-4 singular-project-container lead">
                <div class="project-paragraphs">
                  ...
                  <p class="project-about">
                    ...
                    łączy wiedzę teoretyczną z praktyczną poprzez realizowane wspólnie z firmami warsztaty oraz projekty
                    IT.
                  </p>
                </div>
	...
	<div class="section fullpage--3">
		...
		<section id="partners" class="partners">
		        <div class="partners_container container">
		          <div class="row">
		            <div class="navy_bg col-xl-12 col-lg-12 col-12">
		              <p class="col-xl-12 col-md-12">
		                <span>SKN Konsultingu IT zaufało już sześć organizacji i każda z nich planuje dalszą</span>

		                <span>współpracę z naszym kołem. Łącząc siły, tworzymy projekty wartościowe</span>

		                <span>zarówno dla studentów, jak i dla prestiżowych firm.</span>

		                <span>To dzięki Wam z każdym rokiem rośniemy.</span>
		        ...
		        <div>
		          <div class="row d-flex justify-content-center">
		            <img class="img" src="./assets/images/skn_partnerzy_dlonie_tlo1.png" width="1200px">
		        ...
		        <div class="white_bg d-flex justify-content-center">
		          ...
		          <div class="row second">
		            <div class="col-xl-2 col-2" rel="partner1">
		              <img src="./assets/images/Microsoft.png" width="150">
		            </div>
		            <div class="col-xl-2 col-2" rel="partner2">
		              <img src="./assets/images/PG.png" width="75" height="75">
		            </div>
		            <div class="col-xl-2 col-2" rel="partner3">
		              <img src="./assets/images/pwc.png" width="75" height="75">
		            </div>
		            <div class="col-xl-2 col-2" rel="partner4">
		              <img src="./assets/images/McKinsey.png" width="175" height="75">
		            </div>
		            <div class="col-xl-4 col-4">
		              <div id="partner1">
		                ...
		                <img src="./assets/images/Microsoft.png" width="150" class="partnerSmallerLogo">
		              </div>
		              <div id="partner2" style="display:none">
		                ...
		                <img src="./assets/images/PG.png" width="75" height="75" class="partnerSmallerLogo">
		              </div>
		              <div id="partner3" style="display:none">
		                ...
		                <img src="./assets/images/pwc.png" width="75" height="75" class="partnerSmallerLogo">
		              </div>
		              <div id="partner4" style="display:none">
		                ...
		                <img src="./assets/images/McKinsey.png" width="175" height="75" class="partnerSmallerLogo">
		              </div>
		            </div>
		          </div>
		        </div>
		        <div class="row">
		          <div class="partnersEndText" style="opacity:0;">
		            <p>To dzięki Wam z każdym rokiem rośniemy.</p>
		            </br>
		            </br>
		            <p>Dziękujemy!</p>
		          </div>
	...
	<div class="section fullpage--5">
        ...
        <div class="mobile d-flex col-12">

          <!-- CAROUSEL START -->

          <div id="carouselExampleIndicators3" class="carousel carousel3 slide" data-ride="carousel">
	...
	<div class="section fullpage--6">
		<!--  -->
		<section class="contact--3">
        <div class="container">
          <div class="contact__recrutation header__description">
            <h2 class="contact__title contact__title--1 recruitment">Rekrutacja</h2>
            <span>Już dziś masz szansę dołączyć do jednego z najbardziej</span>
            <span>aktywnych kół naukowych!</span>
            <span class="">Jesteśmy grupą ambitnych ludzi, którzy nie tylko mają wiele</span>
            <span class="">świetnych pomysłów, ale przede wszystkim z konsekwencją</span>
            <span class="">wcielają je w życie,</span>
            <span class="">It's not about great ideas, it's about making ideas happen!</span>
          ...
          <div class="contact__message">
            <h2 class="contact__title recruitment">Kontakt</h2>
            <img src="./assets/images/cezary.png" alt="Zdjęcie sylwetki opiekuna partnerstwa" />

            <div class="contact__message-box">
              <h4 class="conact__mesage-box__title">Opiekun partnerstwa</h4>
              <div class="contact__mesage-author">
                <p class="contact__mesage-title">Cezary Zajkowski</p>
                <p class="contact__mesage-mail">e-mail: cezary.zajkowski@skn.pl</p>
                <p class="contact__mesage-phone">nr. tel: 235 645 334</p>
              </div>
            </div>

            <button id="click3" data-toggle="modal" data-target="#exampleModalCenter" name="submit" type="submit" class="contact__recrutation--btn">Rekrutacja</button>
          </div>
        </div>
		...
		<section class="container d-flex justify-content-center align-items-center section__contact">
			...
			<div class="section__contact__text col flex-column d-flex align-items-center">
				...
				<p class="recruitment" style="display:none">REKRUTACJA</p>
				          <p>
				            <span>Już dziś masz szansę dołączyć do jednego z najbardziej</span>
				            <span>aktywnych kół naukowych!</span>
				            <span class="__about">Jesteśmy grupą ambitnych ludzi, którzy nie tylko mają wiele</span>
				            <span class="__about">świetnych pomysłów, ale przede wszystkim z konsekwencją</span>
				            <span class="__about">wcielają je w życie,</span>
				            <span class="__about__motto">It's not about great ideas, it's about making ideas happen!</span>
				            <span>To właśnie tym się kierujemy, łącząc obszar IT z biznesem.</span>
				            <span>Dołącz do nas, zdobądź wartościowe umiejętności i bądź</span>
				            <span>atrakcyjnym kandydatem dla najbardziej prestiżowych firm.</span>
				            <span>Już teraz wypełnij krótki formularz, spotkaj się z nami</span>
			...
			<div class="col">
				<div class="recruitment" id="contactText" style="display:none">KONTAKT</div>
					...
					<form id="form-object"class="form d-flex form-modal" action="<?php echo base_url() ?>index.php/contact/postEmail" method="post">
						...
						<fieldset id="form-content" class="form__items-right">
							...
							<div class="form-item">
								...
								<textarea id="formMessage" name="formMessage" placeholder="Treść wiadomości" class="textarea validateObjectTextArea" required></textarea>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
			  ...
			  echo validation_errors();
			   ?>
			  <?php echo form_open('index.php/pages/create',array('id'=>"f-contact")); ?>
				<form class="form-recruitment d-flex" id="f-contact" action="index.php/pages/create">
					<fieldset class="form-recruitment __items d-flex flex-column">
						<div class="form-item d-flex flex-column">
							...
							<input id="formNameRecruitment" type="text" name="nazwisko" placeholder="Imię i nazwisko"                 data-validation="required" data-validation-error-msg="pole wymagane"
                          data-validation-error-msg-container=".error-select"
							/>
						</div>
						<div class="form-item d-flex flex-column">
							<label for="formDepartmentRecruitment">2. Co studiujesz i na jakim wydziale:</label>
							<input id="formDepartmentRecruitment" type="text" name="wydzial" placeholder="Kierunek i wydział"
							data-validation="required" data-validation-error-msg="pole wymagane"
                          data-validation-error-msg-container=".error-select"
							/>
						</div>

						<label>
							<?php echo form_radio("rok","I","true",set_radio("rok","I")) ?>
							I
						</label>
						<label>
						...
						<div class="form-item d-flex flex-column">
							...
							<input id="formEmailRecruitment" type="email" name="email" placeholder="E-mail"
							data-validation="email" data-validation-error-msg="pole wymagane" />
						</div>
						<div class="form-item d-flex flex-column">
							...
							<input id="formPhoneRecruitment" type="number" name="telefon" placeholder="Numer telefonu"
							data-validation="required" data-validation-error-msg="pole wymagane"
							  />
						</div>
						<div class="form-item d-flex flex-column">
							...
							<textarea class="" id="formAboutRecruitment" name="opis" placeholder="Tekst"
							data-validation="required" data-validation-error-msg="pole wymagane"
							></textarea>
						</div>
						<div class="form-item d-flex flex-column">
							...
							<div class="form-item__row-checkbox-departmentChoice">
								<div class="checkbox">
									<label>
										<!-- <?php echo form_checkbox("dzial[]",'Partnerstwa i marketingu',set_checkbox("dzial[]","Partnerstwa i marketingu")) ?> -->
										<input type="checkbox" name="dzial[]" value="Partnerstwa i marketingu"
										data-validation="checkbox_group" data-validation-qty="min1"
										data-validation-error-msg-container="#email-error-dialog1"
										>
								...
								<div class="checkbox">
									<label>
										...
										Operacyjnym
											...
											<div id="email-error-dialog1" style="color:rgb(185, 74, 72);"></div>
							</div>
						</div>
						<div class="form-item d-flex flex-column">
							...
							<div class="form-item__row-checkbox">
								<div class="form-item__row-checkbox-projectRecruitment">
									...
									<label>
										...
										<input type="checkbox" name="projekt[]" value="ThinkIT"
										data-validation="checkbox_group" data-validation-qty="min1"
									...
									<label>
										...
										<input type="checkbox" name="projekt[]" value="Lead">
										Lead in IT
									</label>
									<label>
										<!-- <?php echo form_checkbox("projekt[]",'Start-up',set_checkbox("projekt[]","Start-up")) ?> -->
										<input type="checkbox" name="projekt[]" value="Start-up">
										Start-up Game
									</label>
								</div>
								<div class="form-item__row-checkbox-projectRecruitment">
									<label>
										...
										<input type="checkbox" name="projekt[]" value="SkillTrade">
										SkillTrade
									</label>
									<label>
										<!-- <?php echo form_checkbox("projekt[]",'Devhouse',set_checkbox("projekt[]","Devhouse")) ?> -->
										<input type="checkbox" name="projekt[]" value="Devhouse">
								...
								<div class="form-item__row-checkbox-projectRecruitment">
									<label>
										...
										<input type="checkbox" name="projekt[]" value="MyProject">
										Mam swój pomysł na projekt!
									</label>
								</div>
								<div id="email-error-dialog" style="color:rgb(185, 74, 72);"></div>
							</div>
						</div>
						<div class="form-item d-flex flex-column">
							<label for="formHoursRecruitment">9. Ile godzin tygodniowo możesz poświęcić na działalność:</label>
							<input id="formHoursRecruitment" type="number" name="godziny" placeholder="Ilość godzin"
							data-validation="required" data-validation-error-msg="pole wymagane"
                          data-validation-error-msg-container=".error-select"
							  />
						</div>
						<div class="form-item d-flex flex-column">
							...
							<input id="formPubRecruitment" type="text" name="pub" placeholder="Pub"
							data-validation="required" data-validation-error-msg="pole wymagane"
                          data-validation-error-msg-container=".error-select"
							  />
						</div>
