...
(function(global, factory) {
  ...
  $.fn.fullpage = function(options) {
      ...
      if (!options.autoScrolling || options.scrollBar) {
        ...
        if (!currentSection.hasClass(ACTIVE)) {
          ...
          if (canScroll) {
            ...
            $.isFunction(options.afterLoad) &&
              options.afterLoad.call(currentSection, anchorLink, sectionIndex);
    ...
    function moveSlide(direction, section) {
      var activeSection =
        typeof section === "undefined" ? $(SECTION_ACTIVE_SEL) : section;
    ...
    function slideBulletHandler(e) {
      ...
      var slides = $(this)
        .closest(SECTION_SEL)
        .find(SLIDES_WRAPPER_SEL);
      var destiny = slides.find(SLIDE_SEL).eq(
        $(this)
          .closest("li")
          .index()
      );
    ...
    function onTab(e) {
      ...
      if (activeElement.length) {
        if (
          !activeElement.closest(SECTION_ACTIVE_SEL, SLIDE_ACTIVE_SEL).length
        ) {
    ...
    function addAnimation(element) {
      var transition =
        "all " + options.scrollingSpeed + "ms " + options.easingcss3;
    ...
    function addTableClass(element) {
      ...
      if (!element.hasClass(TABLE)) {
        var wrapper = $('<div class="' + TABLE_CELL + '" />').height(
